...
- You must have some experience with mobile test development using Appium. We are not providing support to those who does not have knowledge of Appium, or to those who never develloped test automation with Appium
