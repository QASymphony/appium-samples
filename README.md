...
- You must have some experience with mobile test development using Appium. We are not providing support to those who does not has knowledge of Appium, as well to those who never devellop test automation with Appium
